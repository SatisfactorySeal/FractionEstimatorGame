/**
 * A class representing a group of fractions. These fractions will be displayed and move down
...
public class FractionSet {
  ...
  /** 
   * Constructor for FractionSet
   * numOptions guarantee has not been determined yet
   * guarantees 2 <= demonSize <= 15
   */
  public FractionSet(int numOptions, int denomSize) {
